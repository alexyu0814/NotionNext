...
const BLOG = {
  ...
  AUTHOR: process.env.NEXT_PUBLIC_AUTHOR || '骑着单车去钓鱼', // 您的昵称 例如 tangly1024
  BIO: process.env.NEXT_PUBLIC_BIO || '记录和整理有趣、有价值、有意义的内容，包括公众号、视频、微博、博客、播客等所有非书籍的来源', // 作者简介
  LINK: process.env.NEXT_PUBLIC_LINK || 'https://www.fengnet.link/', // 网站地址
  KEYWORDS: process.env.NEXT_PUBLIC_KEYWORD || 'AI,chatGPT,人工智能, 博客', // 网站关键词 英文逗号隔开
